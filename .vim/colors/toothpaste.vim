...
hi DiffAdd ctermfg=188 ctermbg=64 cterm=bold guifg=#BFC6C7 guibg=#45840f gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#8a090a guibg=NONE gui=NONE
hi DiffChange ctermfg=188 ctermbg=23 cterm=NONE guifg=#BFC6C7 guibg=#213c5d gui=NONE
hi DiffText ctermfg=188 ctermbg=24 cterm=bold guifg=#BFC6C7 guibg=#204a87 gui=bold
...
hi Tag ctermfg=188 ctermbg=NONE cterm=NONE guifg=#BFC6C7 guibg=NONE gui=NONE
hi Title ctermfg=188 ctermbg=NONE cterm=bold guifg=#BFC6C7 guibg=NONE gui=bold
...
" HTML
hi htmlTag ctermfg=109 ctermbg=NONE cterm=NONE guifg=#769eb3 guibg=NONE gui=NONE
hi htmlEndTag ctermfg=109 ctermbg=NONE cterm=NONE guifg=#769eb3 guibg=NONE gui=NONE
hi htmlTagName ctermfg=109 ctermbg=NONE cterm=NONE guifg=#769eb3 guibg=NONE gui=NONE
...
hi yamlKey ctermfg=188 ctermbg=NONE cterm=NONE guifg=#BFC6C7 guibg=NONE gui=NONE
...
hi cssPseudoClassId ctermfg=188 ctermbg=NONE cterm=NONE guifg=#BFC6C7 guibg=NONE gui=NONE
hi cssClassName ctermfg=188 ctermbg=NONE cterm=NONE guifg=#BFC6C7 guibg=NONE gui=NONE
