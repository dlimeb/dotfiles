...
hi Cursor ctermfg=17 ctermbg=220 cterm=NONE guifg=#002f4f guibg=#ffc600 gui=NONE
hi Visual ctermfg=NONE ctermbg=25 cterm=NONE guifg=NONE guibg=#0050a4 gui=NONE
hi CursorLine ctermfg=NONE ctermbg=23 cterm=NONE guifg=NONE guibg=#194461 gui=NONE
hi CursorColumn ctermfg=NONE ctermbg=23 cterm=NONE guifg=NONE guibg=#194461 gui=NONE
hi ColorColumn ctermfg=NONE ctermbg=23 cterm=NONE guifg=NONE guibg=#194461 gui=NONE
hi LineNr ctermfg=103 ctermbg=23 cterm=NONE guifg=#8097a7 guibg=#194461 gui=NONE
hi VertSplit ctermfg=60 ctermbg=60 cterm=NONE guifg=#4a6b82 guibg=#4a6b82 gui=NONE
hi MatchParen ctermfg=214 ctermbg=NONE cterm=NONE guifg=#002f4f guibg=#f0c674 gui=NONE
hi StatusLine ctermfg=15 ctermbg=60 cterm=bold guifg=#ffffff guibg=#4a6b82 gui=bold
hi StatusLineNC ctermfg=15 ctermbg=60 cterm=NONE guifg=#ffffff guibg=#4a6b82 gui=NONE
...
hi IncSearch ctermfg=17 ctermbg=76 cterm=NONE guifg=#002f4f guibg=#3ad900 gui=NONE
hi Search ctermfg=NONE ctermbg=NONE cterm=NONE guifg=#002f4f guibg=#f0c674 gui=NONE
hi Directory ctermfg=204 ctermbg=NONE cterm=NONE guifg=#ff628c guibg=NONE gui=NONE
hi Folded ctermfg=33 ctermbg=17 cterm=NONE guifg=#0088ff guibg=#002f4f gui=NONE

hi Normal ctermfg=15 ctermbg=17 cterm=NONE guifg=#ffffff guibg=#002f4f gui=NONE
...
hi Comment ctermfg=33 ctermbg=NONE cterm=NONE guifg=#aaaaaa guibg=NONE gui=italic
...
hi DiffAdd ctermfg=15 ctermbg=64 cterm=bold guifg=#ffffff guibg=#3e8515 gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#830910 guibg=NONE gui=NONE
hi DiffChange ctermfg=15 ctermbg=23 cterm=NONE guifg=#ffffff guibg=#103d6b gui=NONE
...
hi Identifier ctermfg=220 ctermbg=NONE cterm=NONE guifg=#ffdd00 guibg=NONE gui=NONE
...
hi NonText ctermfg=220 ctermbg=23 cterm=NONE guifg=#ffc600 guibg=#0d3958 gui=NONE
...
hi SpecialKey ctermfg=220 ctermbg=23 cterm=NONE guifg=#ffc600 guibg=#194461 gui=NONE
hi Statement ctermfg=214 ctermbg=NONE cterm=NONE guifg=#ff9d00 guibg=NONE gui=NONE
hi StorageClass ctermfg=220 ctermbg=NONE cterm=NONE guifg=#ffdd00 guibg=NONE gui=NONE
...
hi javaScriptFunction ctermfg=220 ctermbg=NONE cterm=NONE guifg=#ffdd00 guibg=NONE gui=NONE
