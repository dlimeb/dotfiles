...
"hi StatusLine   guibg=#cc4455  guifg=white    gui=none ctermbg=4  ctermfg=11
"hi StatusLine   guibg=#bcd42a  guifg=#222222    gui=none ctermbg=4  ctermfg=11
hi StatusLine   guibg=#557799  guifg=#ffffff    gui=none ctermbg=4  ctermfg=11
hi StatusLineNC     guibg=#aaaaaa  guifg=#242933     ctermbg=14 ctermfg=0
hi VertSplit      guifg=#242933 ctermfg=234  guibg=#242933 ctermbg=234
...
hi Statement   guibg=bg    guifg=#FF5D38      ctermbg=bg  ctermfg=14 gui=none
...
hi Todo     guibg=#ffff00  guifg=bg      ctermbg=1   ctermfg=12
